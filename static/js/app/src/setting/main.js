define("app/src/setting/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "./setting", "./fav", "./group", "./member", "./system"], function(e) {
    ...
    var e, t = "index.php?member/",
        ...
        s = function() {
            ...
            for (var s in e) t += o(e[s].name, e[s].role);
        ...
        o = function(e, t) {
            ...
            var s = "<tr name='" + urlDecode(e) + "' role='" + t + "'>" + "   <td>" + e + "</td>" + "   <td><a href='javascript:void(0)' class='edit_role'>" + a + "</a></td>" + "   <td>" + n + "</td>" + "</tr>";
            return s
        },
        r = function(e, t, i) {
            ...
            var s = "<tr name='" + t + "' role='" + i + "'>" + "   <td class='member'>" + LNG.username + ":<input type='text' id='name' value='" + t + "'/>" + "       <span>" + LNG.password + ":</span><input type='text' id='password'/></td>" + "   <td><select id='role' value='" + i + "'>" + a + "</select></td>" + "   <td>" + "       <a href='javascript:void(0)' class='button " + n.b1 + "</a>" + "       <a href='javascript:void(0)' class='button " + n.b2 + "</a>" + "   </td>" + "</tr>";
            return s
        },
        l = function() {
            var e = r("add");
