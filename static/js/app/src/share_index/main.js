define("app/src/share_index/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../share_common/topbar", "./fileShow", "../edit/mode"], function(e) {
    ...
    var t = "index.php?share/fileDownload&user=" + G.user + "&sid=" + G.sid,
        a = "index.php?share/fileProxy&user=" + G.user + "&sid=" + G.sid,
        i = function() {
        ...
        o = function() {
            var t = e("../edit/mode");
            $.get(a, function(e) {
                var a = core.pathExt(G.share_info.path),
                    i = t.get(a),
                    n = '<pre class="code">' + s(e) + "</pre>";
                $(".content_box").addClass("show_code").append(n);
                var o = ace.require("ace/ext/static_highlight");
                ace.require("ace/lib/dom"), o($(".code").get(0), {
                    mode: "ace/mode/" + i,
                    wrapMode: !0,
        ...
        r = function(e) {
            if (inArray(core.filetype.text, e) || inArray(core.filetype.code, e)) return o(), void 0;
            if ("swf" == e) {
            ...
            if ("pdf" == e) {
                ...
                return $(".content_box").attr("id", "show_pdf").append(t), new PDFObject({
                    url: a
                }).embed("show_pdf"), void 0
            }
            ...
            if (inArray(core.filetype.music, e) || inArray(core.filetype.movie, e)) {
                var i = "skins/music/manila.zip",
                    s = "music_player";
                inArray(core.filetype.movie, e) && (i = "skins/movie/webplayer.zip", s = "movie_player");
                var r = G.app_host + a + "#name_" + G.share_info.path,
                    l = G.static_path + "js/lib/cmp4/cmp.swf",
                    c = "url=&lists=&context_menu=2&auto_play=1&play_mode=1&name=kodExplorer&src=" + urlEncode(r) + "&skin=" + urlEncode(i) + "&label=" + G.share_info.path,
                    t = core.createFlash(l, c, s);
                return $(".content_box").addClass(s).append(t), void 0
            }
