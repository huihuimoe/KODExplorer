define("app/src/share_explorer/main", ["lib/jquery-lib", "lib/util", "lib/ztree/js/ztree", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "lib/picasa/picasa", "./ui", "./fileSelect", "../../share_common/rightMenu", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/tree", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer", "./path", "../../share_common/topbar"], function(e) {
    Config = {
        ...
        TreeId: "folderList",
        pageApp: "explorer",
        treeAjaxURL: "index.php?share/treeList&app=folder&user=" + G.user + "&sid=" + G.sid,
        AnimateTime: 200
    }, Global = {
        fileListAll: "",
        fileListNum: 0,
    ...
    this._hover_title = function(e) {
        ...
        if ("oexe" == e.ext && void 0 != e.icon) {
            var a = e.icon; - 1 == e.icon.search(G.static_path) && "http" != e.icon.substring(0, 4) && (a = G.static_path + "images/app/" + e.icon);
            ...
            var s = core.path2url(G.this_path + e.name),
                o = "index.php?share/image&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode(G.this_path + e.name);
        ...
        if ("oexe" == e.ext) {
            ...
            var n = core.path2url(G.this_path + e.name),
                s = "index.php?share/image&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode(G.this_path + e.name);
            ...
            addressSet: function() {
                ...
                var t = function(e) {
                    ...
                    var n = i[0] + "/",
                        s = t.replace(/@1@/g, n),
                        o = i[0];
                    s = s.replace("{$2}", i.length), s = s.replace("{$3}", o);
            ...
            var u = function(e) {
                ...
                h = function(e) {
                    ...
                    var a = e.clientX >= n - 50 ? n - 50 : e.clientX,
                        d = e.clientY >= i - 50 ? i - 50 : e.clientY;
                    a = 0 >= a ? 0 : a, d = 0 >= d ? 0 : d, a -= o, d -= r, $(".draggable-dragging").css("left", a), $(".draggable-dragging").css("top", d), Global.isIE && $("." + Config.TypeFolderClass).each(function() {
                        var t = e.pageX,
                            a = e.pageY,
                            i = $(this).offset(),
                            n = $(this).width(),
...
define("app/src/share_explorer/path", ["../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"], function(e) {
    ...
    var n = function(e, t, a) {
        ...
        s = function() {
            var e = ["/"],
                t = 0,
                a = function() {
                    return G.this_path == e[e.length - 1] ? (s(), void 0) : (t != e.length - 1 && (e = e.slice(0, t)), e.push(G.this_path), t = e.length - 1, s(), void 0)
                },
                i = function() {
                    e.length - 1 >= t + 1 && (t += 1, G.this_path = e[t], ui.f5(!0, !0), s())
                },
                n = function() {
                    t - 1 >= 0 && (t -= 1, G.this_path = e[t], ui.f5(!0, !0), s())
                },
                s = function() {
        ...
        r = function(e) {
            if ("" != e) {
                ...
                0 != i.list.length && (o(i.list[i.index++]), i.index == i.list.length && (i.index = 0))
            }
        },
        l = function(e) {
    ...
    return {
        ...
        show_file: function() {
            var e = "./index.php?share/file&sid=" + G.sid + "&user=" + G.user + "&path=" + urlEncode(c().path);
            window.open(e)
        },
        openProject: function() {
        ...
        setSearchByStr: l,
        setSelectByChar: r,
        setSelectByFilename: o
    }
}), define("app/share_common/topbar", [], function() {
    var e = "index.php?share/fileDownload&user=" + G.user + "&sid=" + G.sid,
        t = "index.php?share/fileProxy&user=" + G.user + "&sid=" + G.sid,
        a = function() {
