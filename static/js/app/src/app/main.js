define("app/src/app/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "./page"], function(e) {
    ...
    var e, a = function() {
            e = location.hash.split("#", 2)[1], e || (e = "all"), i(e), $("ul.setting li").hover(function() {
                ...
                var e = "index.php?setting/set&k=" + type + "&v=" + value;
                $.ajax({
                    url: e,
                    type: "json",
                    success: function(e) {
                ...
                if ($(e.target).attr("action")) {
                    var a = json_decode(urlDecode($(this).attr("data"))),
                    ...
                    switch (t) {
                        ...
                        case "add":
                            ...
                            var n = share.data("create_app_path"),
                                o = urlEncode(n + a.name),
                        ...
                        case "del":
                            $.ajax({
                                url: "./index.php?app/del&name=" + urlEncode(a.name),
                                dataType: "json",
                                error: core.ajaxError,
                                success: function(e) {
